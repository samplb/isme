...
public class MySqlTerms {
	...
	public static final String[] createStatementsMySQL= {
			...
			"ALTER TABLE `buero`  ADD CONSTRAINT `buero_ibfk_1` FOREIGN KEY (`gnr`) REFERENCES `gebaeude` (`gnr`) ON UPDATE CASCADE ON DELETE  CASCADE",
			"ALTER TABLE `bueromit`  ADD CONSTRAINT `bueromit_ibfk_1` FOREIGN KEY (`bnr`) REFERENCES `buero` (`bnr`) ON UPDATE CASCADE ON DELETE  CASCADE,  ADD CONSTRAINT `bueromit_ibfk_2` FOREIGN KEY (`mnr`) REFERENCES `mitarbeiter` (`mnr`) ON UPDATE CASCADE ON DELETE  CASCADE,  ADD CONSTRAINT `bueromit_ibfk_3` FOREIGN KEY (`gnr`) REFERENCES `buero` (`gnr`) ON UPDATE CASCADE ON DELETE  CASCADE",
			"ALTER TABLE `bueromitarbeiter`  ADD CONSTRAINT `bueromitarbeiter_ibfk_1` FOREIGN KEY (`mnr`) REFERENCES `mitarbeiter` (`mnr`) ON UPDATE CASCADE ON DELETE  CASCADE",
			"ALTER TABLE `chef`  ADD CONSTRAINT `chef_ibfk_1` FOREIGN KEY (`mnr`) REFERENCES `mitarbeiter` (`mnr`)",
			"ALTER TABLE `fahrzeug`  ADD CONSTRAINT `fahrzeug_ibfk_1` FOREIGN KEY (`mnr_mechaniker`) REFERENCES `mechaniker` (`mnr`) ON UPDATE CASCADE ON DELETE  CASCADE,  ADD CONSTRAINT `fahrzeug_ibfk_2` FOREIGN KEY (`mnr_buero`) REFERENCES `bueromitarbeiter` (`mnr`) ON UPDATE CASCADE ON DELETE  CASCADE",
			"ALTER TABLE `garage`  ADD CONSTRAINT `garage_ibfk_1` FOREIGN KEY (`gnr`) REFERENCES `gebaeude` (`gnr`) ON UPDATE CASCADE ON DELETE  CASCADE",
			"ALTER TABLE `garagemit` ADD CONSTRAINT `garagemit_ibfk_1` FOREIGN KEY (`mnr`) REFERENCES `mitarbeiter` (`mnr`) ON UPDATE CASCADE ON DELETE  CASCADE,  ADD CONSTRAINT `garagemit_ibfk_2` FOREIGN KEY (`garagenr`) REFERENCES `garage` (`garagenr`) ON UPDATE CASCADE ON DELETE  CASCADE, ADD CONSTRAINT `garagemit_ibfk_3` FOREIGN KEY (`gnr`) REFERENCES `garage` (`gnr`) ON UPDATE CASCADE ON DELETE  CASCADE",
			"ALTER TABLE `gebaeude`  ADD CONSTRAINT `gebaeude_ibfk_1` FOREIGN KEY (`unr`) REFERENCES `unternehmen` (`unr`) ON UPDATE CASCADE ON DELETE  CASCADE",
			"ALTER TABLE `mechaniker`  ADD CONSTRAINT `mechaniker_ibfk_1` FOREIGN KEY (`mnr`) REFERENCES `mitarbeiter` (`mnr`) ON UPDATE CASCADE ON DELETE  CASCADE",
			"ALTER TABLE `mitarbeiter`  ADD CONSTRAINT `mitarbeiter_ibfk_1` FOREIGN KEY (`unr`) REFERENCES `unternehmen` (`unr`) ON UPDATE CASCADE ON DELETE  CASCADE",
	};
		...
		public static final String unternehmensnamen ="amstec";
		...
		public static final int maxUnternehmen =1;
